...
user: AST
command: sp.specify
labels: [specification, education, robotics, simulation, digital-twin]
links:
...
# Specify: Module 2 – The Digital Twin (Gazebo & Unity)
